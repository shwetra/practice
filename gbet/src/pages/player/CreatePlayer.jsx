          ...
          <div className="w-full grid lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                id="countryCode"
                name="countryCode"
                className="block min-w-[8rem] w-full p-2 rounded border-gray-300 border focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent undefined "
              >
